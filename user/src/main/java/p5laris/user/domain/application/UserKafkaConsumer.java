...
public class UserKafkaConsumer {
    ...
    public void handleItemPurchaseRequest(String messagePayload) {
        ...
        try {
            ...
            throw new IllegalArgumentException("아이템 구매 요청 메시지 역직렬화에 실패했습니다.", e);
        }
        ...
        try {
            ...
            throw new IllegalStateException("아이템 구매 요청 처리에 실패했습니다.", e);
        }
    }
    ...
    public void handleStarPieceEarnRequested(String messagePayload) {
        ...
        try {
            ...
            throw new IllegalArgumentException("별조각 적립 요청 메시지 역직렬화에 실패했습니다.", e);
        }
